...
const PendingWalletTransactions = () => {
  ...
  return (
    <MotionConfig transition={{ type: "spring", bounce: 0, duration: 0.2 }}>
      <motion.div
        layoutId="pending-wallet-transactions"
        className="flex flex-col max-w-[320px] h-auto w-full"
      >
        <MotionConfig transition={{ type: "spring", bounce: 0, duration: 0.2 }}>
          <motion.div
            whileTap={{
          ...
          {/* List view */}
          <motion.div className="w-full space-y-2 mt-2 relative">
            {transactions.map((transaction, idx) => (
              <motion.div
                ...
                className={`relative border w-full rounded-xl gap-2 p-2 flex bg-white ${
                  !open && idx !== 0 ? "pointer-events-none" : ""
                }`}
              >
                ...
                <motion.div
                  animate={{
                    opacity: !open && idx !== 0 ? 0 : 1,
                  }}
                  className="flex flex-col items-center justify-center flex-1"
                >
                  <motion.div className="flex items-center space-x-2 w-full">
                  ...
                  <motion.div className="flex items-center justify-between space-x-2 w-full">
